...
export default function Navbar() {
    ...
    return (
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-stone-700'>
                <NavLink to='/' className='flex flex-col items-center gap-1'>
                    <p>HOME</p>
                    <hr className='w-2/4 border-none h-[1.5px] bg-stone-700 hidden' />
                </NavLink>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    <img src={user} alt="" className="w-5 cursor-pointer icon-thin"/>
                    <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                        <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-stone
-500 rounded'>
