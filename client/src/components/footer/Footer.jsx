        ...
        <div>
            <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
                <div>
                    ...
                    <p className='w-full md:w-2/3 text-stone-600'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos adipisci, voluptatem repellendus possimus iste nesciunt nisi neque laboriosam eum impedit voluptatibus dolore ad blanditiis tempora beatae! Ab autem voluptate cumque.</p>
                </div>
